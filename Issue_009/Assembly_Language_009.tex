...
\noindent
\textbf{Download from:}\\
\url{https://github.com/NormanDunbar/QLAssemblyLanguageMagazine/releases/tag/Issue_9}\\ % Download [latest issue] URL
...
\noindent Copyright \copyright 2021 Norman Dunbar\\ % Copyright notice
