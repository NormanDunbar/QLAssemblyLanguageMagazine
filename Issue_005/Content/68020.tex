...
So the first thing to note is that attempting to use an numeric literals for the offsets will cause assembly errors is they are outside the range 0 to 31 inclusive. This is why we had to use \opcode{D2} as the offset and the receiving register for one of the instructions.
