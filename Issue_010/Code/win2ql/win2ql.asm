...
checkStack
    ...
    beq.s   win2ql            ; Ok, skip error bit
...
overflow
    cmpi.l  #ERR_BFFL,d0      ; Overflow?
    beq.s   gotLine           ; Yes, write it out
    cmpi.l  #ERR_OVFL,d0      ; Overflow (alternative)?
    beq.s   gotLine           ; Yes, write it out
    bra     errorExit         ; Oops!
