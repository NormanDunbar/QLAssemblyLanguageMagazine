...
\input{../Common/macros.tex} % Insert my own macros.
\input{config.tex} % Insert the config for this particular issue.
...
\noindent
\textbf{Download from:}\\
\url{https://github.com/NormanDunbar/QLAssemblyLanguageMagazine/releases/tag/Issue_12}\\ % Download [latest issue] URL
...
\noindent Copyright \copyright~\the\year{} Norman Dunbar (and any guest contributors).\\ % Copyright notice
...
%----------------------------------------------------------------------------------------
% And the cover? What's that all about then?
%----------------------------------------------------------------------------------------
