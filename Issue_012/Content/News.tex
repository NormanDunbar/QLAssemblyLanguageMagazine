...
The book is now at the production stage, so I'm available for other things now.
...
Also, the various email addresses I used to use are now gone. Any feedback on the topics in this and future issues should be directed at the email address in the \nameref{section: feedback} section on page \pageref{section: feedback}.
