...
\DeclareRobustCommand{\eMagIssue}{002}
\DeclareRobustCommand{\eMagAuthor}{Norman Dunbar}

\hypersetup{
	pdftitle={\eMagTitle~-~\eMagIssue},
...
\noindent Copyright \copyright 2014-2015 Norman Dunbar\\ % Copyright notice

\noindent \textsc{Published by MeMyselfEye Publishing ;-)}\\ % Publisher

\noindent %\url{http://qdosmsq.dunbar-it.co.uk/downloads/AssemblyLanguage/Issue_002/Assembly_Language_002.pdf}\\ % Download URL
...
%----------------------------------------------------------------------------------------
%Here come the contents of the book...You'll have to amend this for every issue of the
% irregular eComic.
%----------------------------------------------------------------------------------------
