...
\graphicspath{{../Common/Pictures/}} % Specifies the directory where pictures are stored
...
% To allow tables to be coloured in the background, 
% not just the text.
\usepackage{colortbl}
